package com.apporio.billiondriver.urls;
...
/*    String BASE = "http://apporioinfolabs.com/ApporiotaxiOnesignal/";
    ...
    String BASE = "http://apporio.org/Billion/";
    String baseDomain = BASE + "api/";
    String imageDomain = BASE + "";
    String restdomain = BASE + "Billion/";
    ...
    String tC = baseDomain + "tc_driver.php";
    ...
    String WALLET_BALANCE_FETCH = baseDomain + "driver_wallet_transactions.php\n";
