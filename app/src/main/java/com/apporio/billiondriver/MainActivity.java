...
import com.apporio.billiondriver.manager.DeviceManager;
...
import com.apporio.billiondriver.models.ActiveRidesResponse;
import com.apporio.billiondriver.models.CallSupportResponse;
import com.apporio.billiondriver.models.ModelReportIssue;
import com.apporio.billiondriver.models.ModelScheduleAndunacceptedRide;
import com.apporio.billiondriver.models.ResultCheck;
import com.apporio.billiondriver.models.deviceid.DeviceId;
import com.apporio.billiondriver.models.restmodels.NewHeatmapModel;
...
public class MainActivity extends BaseActivity implements Apis,
    ...
    com.apporio.billiondriver.samwork.ApiManager apiManager_new;
    ...
    private void menuListeners() {
        ...
        findViewById(R.id.my_earnings_menu_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, com.apporio.billiondriver.earnings.EarningActivity.class));
            }
        });

        findViewById(R.id.my_wallet_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
